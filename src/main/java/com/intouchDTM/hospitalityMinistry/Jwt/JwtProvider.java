package com.intouchDTM.hospitalityMinistry.Jwt;

import com.intouchDTM.hospitalityMinistry.Config.ExpireTime;
...
public class JwtProvider {
    ...
    public JwtProvider(@Value("${oauth.jwt.secret}") String secretKey) {
